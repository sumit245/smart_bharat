...
<section class="hero" aria-labelledby="hero-title">
  ...
  <div class="container hero__inner">
    <div class="reveal">
      <span class="hero__eyebrow"><span class="dot"></span>India's Largest Network of Independent Digital
        Creators</span>
      <h1 class="hero__title" id="hero-title">
        An Institution
        <span class="accent">That Is Ready
          <span class="accent-blue">to Back You.</span></span>
      </h1>
      <p class="hero__lede">From grassroots regional voices to elite national platforms — SMaRT stands behind every
        creator who tells Bharat's story with courage and conviction. Free membership.</p>
      <div class="hero__cta">
        <a href="/join" class="btn btn--navy btn--lg">Join Free <span class="arr" aria-hidden="true">→</span></a>
        <a href="/donate" class="btn btn--primary btn--lg">What We Do? <span class="arr" aria-hidden="true">→</span></a>
      </div>
      <div class="hero__trust">
        ...
        <span><strong><?= e((string) $site['stats']['languages']) ?>+</strong> Bharatiya Languages</span>
        <span><strong>Free</strong> Membership</span>
      </div>
    </div>
...
<section class="section section--bg" aria-labelledby="ch-title">
  <div class="container">
    <div class="section__head reveal">
      <span class="section__eyebrow">Why SMaRT Exists</span>
      <h2 class="section__title" id="ch-title">Every Authentic Voice Deserves Institutional Support</h2>
      <p class="section__lede">Independent nationalistic media faces three persistent barriers. SMaRT exists to
        dismantle each one.</p>
    </div>
  ...
  <div class="container">
    <div class="mission">
      <div class="reveal">
        ...
        <h2 class="mission__title" id="mission-title">More Than a Network. An Institution.</h2>
        <h3 class="mission__subhead">About Us</h3>
        <p>SMaRT backs creators at every level — from a regional YouTuber finding their voice, to an established author
          stepping onto a national literary stage. We launch books, co-host lit fests, run cultural campaigns, fund
          research, and stand with you legally when it matters most. All of it, free.</p>
        <!-- <p>We provide the infrastructure, research, training, and financial synergy needed to amplify credible
          narratives and empower the voice of the nation.</p> -->
        <a href="/about" class="btn btn--ghost btn--sm mt-4">Read Our Story <span class="arr"
...
<section class="section section--bg" aria-labelledby="pillars-title">
  <div class="container">
    <div class="section__head reveal">
      <span class="section__eyebrow">What You Get as a Member</span>
...
<section class="section" aria-labelledby="tl-title">
  <div class="container">
    <div class="section__head reveal">
      ...
      <p class="section__lede">From 25 founding members on Dusherra 2020 to a coalition of 350+ portals reaching 400M+
        Bharatiyas.</p>
    </div>
    <div class="timeline">
      ...
      <?php foreach ($features as $i => $f): ?>
        <article class="feature-card reveal" style="transition-delay:<?= $i * 70 ?>ms">
          <span class="feature-card__icon"
            aria-hidden="true"><?php icon($f['icon'], ['width' => 24, 'height' => 24]); ?></span>
          <div>
            <h3><?= e($f['title']) ?></h3>
            <p><?= e($f['summary']) ?></p>
          </div>
...
<section class="coalition" aria-labelledby="co-title">
  <div class="container">
    <div class="reveal">
      <h2 id="co-title">Regional or National. You Belong Here.</h2>
      <p>SMaRT is the only institution in India built to back both — with equal conviction.</p>
      <div class="coalition__cta">
        <a href="/join" class="btn btn--navy btn--lg">Join Free</a>
...
<section class="kpi-strip" aria-label="Impact metrics">
  <div class="container kpi-grid">
    <div class="kpi"><span class="kpi__icon"><?php icon('users', ['width' => 38, 'height' => 38]); ?></span>
      <div><span class="kpi__num" data-count="<?= e((string) $site['stats']['portals']) ?>"
          data-suffix="+">0</span><span class="kpi__label">Portals Connected</span></div>
    </div>
    <div class="kpi"><span class="kpi__icon"><?php icon('amplify', ['width' => 38, 'height' => 38]); ?></span>
      <div><span class="kpi__num"><?= e($site['stats']['reach']) ?></span><span class="kpi__label">Combined Reach</span>
      </div>
    </div>
    <div class="kpi"><span class="kpi__icon"><?php icon('book', ['width' => 38, 'height' => 38]); ?></span>
      <div><span class="kpi__num" data-count="<?= e((string) $site['stats']['journalists']) ?>"
          data-suffix="+">0</span><span class="kpi__label">Journalists Trained</span></div>
    </div>
    <div class="kpi"><span class="kpi__icon"><?php icon('globe', ['width' => 38, 'height' => 38]); ?></span>
      <div><span class="kpi__num">1 Mission</span><span class="kpi__label">Empowering Bharat</span></div>
    </div>
    <div class="kpi-strip__brand">
      <img src="<?= e(asset('/assets/img/logo.png')) ?>" alt="" width="36" height="36">
...
<section class="section" aria-labelledby="faq-title">
  <div class="container">
    ...
    <p class="text-center mt-6"><a href="/faq" class="btn btn--ghost btn--sm">See all FAQs <span class="arr"
