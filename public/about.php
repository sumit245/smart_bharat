...
$impactStats = [
    ['value' => '350+', 'label' => 'media portals connected'],
...
<section class="page-head">
  <div class="container">
    ...
    <h1>The SMaRT Initiative</h1>
    <p>A non-profit force multiplier for independent nationalistic media, Indic journalism, Bharatiya knowledge providers, and digital news platforms working to spread right content and information.</p>
  </div>
</section>
  ...
  <div class="container">
    <div class="mission">
      <div class="reveal">
        ...
        <h2>From Dusherra 2020 to a 400M+ Coalition</h2>
        <p>SMaRT was founded on Dusherra, <?= e(date('Y', strtotime($site['founded']))) ?>, with 25 media members and recording studios in 4 cities. We began with one question: how do small, mission-driven Bharatiya media platforms survive — and thrive — without compromising editorial independence?</p>
        <p>The answer was the coalition. Pooled research, shared infrastructure, financial synergy, and a unified amplification network across 10 Bharatiya languages. Four years later, SMaRT is a force multiplier of 350+ portals reaching 400M+ readers.</p>
  ...
  <div class="container">
    <div class="about-intro reveal">
      <div>
        ...
        <h2 class="section__title">Spread Right Content and Information</h2>
      </div>
      <div class="about-intro__copy">
        <p>SMaRT, the Samachar Manyata Association for Research and Training, is a voluntary coalition formed from compassion and determination for Bharat. It brings together nationalistic media organisations that cover issues of civilisational, cultural, social, ecological, and national importance.</p>
        <p>Independent media often works in silos. SMaRT makes those voices stronger through a global media collective platform: research support, training, amplification, shared learning, and practical cooperation between publishers and knowledge providers.</p>
      </div>
    </div>
...
<section class="section section--navy about-purpose">
  <div class="container">
    <div class="section__head reveal">
      ...
      <p class="section__lede">The live SMaRT idea is simple: help credible voices help each other, so national discourse gains scale without losing rootedness.</p>
    </div>
    <div class="about-purpose__grid">
      <article class="about-purpose__card reveal">
        <span>01</span>
        <h3>Purpose</h3>
        <p>Disseminate Indic knowledge and virtues through a global media collective that reflects civilisational values, inclusiveness, the idea that the world is one family, respect for all life, and care for ecology.</p>
      </article>
      <article class="about-purpose__card reveal" style="transition-delay:60ms">
        <span>02</span>
        <h3>Approach</h3>
        <p>Aid nationalistic media and knowledge providers intellectually, legally, operationally, and materially through research, training, resources, and coalition-led media support.</p>
      </article>
      <article class="about-purpose__card reveal" style="transition-delay:120ms">
        <span>03</span>
        <h3>Role</h3>
        <p>Provide advisory and research strength so independent media owners can publish with better context, stronger evidence, and wider distribution across Bharat and global audiences.</p>
      </article>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="card-grid card-grid--3">
      <article class="card reveal">
        ...
        <p class="card__summary">Journalism that honours Indic knowledge systems, sources of truth, and the lived realities of Bharat.</p>
      </article>
      <article class="card reveal" style="transition-delay:60ms">
        ...
        <p class="card__summary">Members retain full editorial control. SMaRT enables — never edits — member output.</p>
      </article>
      <article class="card reveal" style="transition-delay:120ms">
        ...
        <h3 class="card__title">Vetted Membership</h3>
        <p class="card__summary">Every Approved Nationalistic Portal is reviewed by an editorial jury before listing in the public directory.</p>
      </article>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="container">
    <div class="section__head reveal">
      ...
      <p class="section__lede">SMaRT supports media members without replacing their identity, ownership, audience, or editorial judgment.</p>
    </div>
    <div class="card-grid card-grid--4">
      <?php foreach ($principles as $i => $item): ?>
        <article class="card reveal" style="transition-delay:<?= (int) ($i * 50) ?>ms">
          <div class="card__icon <?= $i % 2 === 0 ? 'card__icon--saffron' : 'card__icon--navy' ?>"><?php icon($item['icon'], ['width' => 28, 'height' => 28]); ?></div>
  ...
  <div class="container">
    <div class="mission mission--reverse">
      <div class="about-support reveal">
        ...
        <p>SMaRT believes equality is strength. More research, more content sharing, better coordination, and wider media literacy create more awareness in society.</p>
        <p>For publishers, creators, and knowledge partners, that means practical support: discoverable directory presence, reliable research inputs, training opportunities, coalition relationships, and a network that understands nationalistic digital media.</p>
        <a class="btn btn--primary" href="/my-account">Join or Login <?php icon('arrow-right', ['width' => 20, 'height' => 20]); ?></a>
      </div>
  ...
  <div class="container">
    <div class="about-cta__inner reveal">
      <div>
        ...
        <p>Whether you run a news website, regional portal, YouTube channel, print publication, creative page, or knowledge initiative, SMaRT gives you a coalition that values independence and works for impact.</p>
      </div>
      <div class="about-cta__actions">
        <a class="btn btn--primary" href="/join">Join the Coalition <?php icon('arrow-right', ['width' => 20, 'height' => 20]); ?></a>
